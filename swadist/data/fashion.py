...
__all__ = ['get_fashionmnist']


def get_fashionmnist(root_dir='./data',
                     download=True,
                     validation=True,
                     validation_prop=0.1,
                     test=True,
    ...
    dataset = FashionMNIST(root=root_dir, train=True, download=download)
    ...
    if validation:
        ...
        valid_dataset = Subset(
            dataset=FashionMNIST(root=root_dir,
                                 train=True,
                                 transform=transform,
                                 download=False),
                                 indices=valid_idx
    ...
    if test:
        test_dataset = FashionMNIST(root=root_dir,
                                    train=False,
                                    transform=transform,
                                    download=download)
